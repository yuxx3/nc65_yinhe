 ...
 * 
 * @since 6.0
 * @version 2010-11-22 下午04:20:01
 * @author yinyxa
 */
public class DelivNumDelOperator implements IRule<DelivBillAggVO> {
	...
	public DelivNumDelOperator(DelivBillAggVO[] bills) {
		super();
	...
	public void process(DelivBillAggVO[] vos) {
		...
		Map<String, List<RewritePara>> paraIndex = tool.splitForDelete(vos);
