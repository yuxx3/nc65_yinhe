...
/**
 * @author yuxx3
 * @created at 2016年6月2日,下午1:53:55
 *
 */
public class GdorderDCImpl implements IGdOrderNM {
	...
	public GDOrderCompStatus[] queryByDataVisibilitySetting(
		...
		//执行存储过程
		String sql = "call pkg_report_pro.gd_ordercompstatus("+AppContext.getInstance().getPkUser()+",'c')";
		execute(sql);
		// (不走管控模式的查询)
		//贸易类型（def1）为DC-c
		StringBuffer whereCondition = new StringBuffer("def1 = 'c'");
		if (paramString != null) {
